...
/*
globals
AD_STYLES, Assign, CHAMPIONS, Clear, DEFAULTS, ENGINE_FEATURES, ENGINE_NAMES, HOST:true, HOST_ARCHIVE:true,
LINKS, THEMES, TWITCH_CHANNEL:true, TWITCH_CHAT:true
*/
'use strict';
...
function StartupConfig()
{
	...
	// 2 & 3 = live engines
	Assign(Clear(ENGINE_NAMES), ['White', 'Black', '7{Blue}', '7{Red}']);
	...
	Assign(Clear(THEMES), ['light', 'dark', 'sea']);
